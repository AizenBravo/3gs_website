...
const PipeV4 = ({ header, body }: PipeV4Props) => {
  return (
    <div className="relative w-full aspect-[500/150] min-h-[140px] flex items-center overflow-hidden rounded-lg select-none">
      ...
      <div className="relative z-10 w-full h-full flex items-center px-[4%] md:px-[6%]">
        ...
        <div className="w-[42%] h-[60%] flex items-center justify-center">
          {header && (
            <PipeLabel className="w-full h-full">
              {header}
            </PipeLabel>
          )}
        </div>
